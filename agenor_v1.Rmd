...
nsfg_data$mystrata[nsfg_data$myrace == "White" & 
                     nsfg_data$myorient == "Lesbian"] <- 7

nsfg_data$mystrata[nsfg_data$myrace == "Black" & 
                     nsfg_data$myorient == "Lesbian"] <- 8

nsfg_data$mystrata[nsfg_data$myrace == "Latina" & 
                     nsfg_data$myorient == "Lesbian"] <- 9
...
nsfg_data$id_18 <- ifelse(nsfg_data$mystrata_factor == 1, 0,
                          ifelse(nsfg_data$mystrata_factor %in% c(8,9), 1, NA))
```
...
```{r}
library(rockchalk)
nsfg_data$mystrata_factor <- combineLevels(nsfg_data$mystrata_factor, levs = c(8, 9), newLabel = c(8))
```
...
```{r}
svychisq(formula = ~prenat_care+id_18,
         design = nsfg_design, 
         statistic = "adjWald")
```
