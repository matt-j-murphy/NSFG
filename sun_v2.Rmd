...
nsfg_data$mystrata[nsfg_data$myrace == "White" & 
                     nsfg_data$myorient %in% c("Lesbian", "Bisexual")] <- 2
...
nsfg_data$mystrata[nsfg_data$myrace == "Latina" & 
                     nsfg_data$myorient == "Heterosexual"] <- 5
...
```{r}
nsfg_data <- nsfg_data %>% 
  mutate(tbl1_relationship = ifelse(rmarital == 6, 1,
                                    ifelse(rmarital == 1, 2,
                                           ifelse(rmarital == 2, 3,
...
```{r}
nsfg_data <- nsfg_data %>% 
  mutate(tbl1_education = ifelse(hieduc %in% c(5,6,7,8), 1,
                                 ifelse(hieduc == 9, 2,
                                        ifelse(hieduc %in% c(10,11), 3,
...
## Make group id dummy for chisq tests of association
```{r}
nsfg_data$id_BW <- ifelse(nsfg_data$myrace == "White", 1,
                          ifelse(nsfg_data$myrace == "Black", 2, NA))

nsfg_data$id_LW <- ifelse(nsfg_data$myrace == "White", 1,
                          ifelse(nsfg_data$myrace == "Latina", 2, NA))

nsfg_data$id_BW <- as.factor(nsfg_data$id_BW)
nsfg_data$id_LW <- as.factor(nsfg_data$id_LW)
```
...
```{r}
svychisq(formula = ~tbl1_age+id_BW,
         design = nsfg_design, 
         statistic = "Chisq")

svychisq(formula = ~tbl1_age+id_LW,
         design = nsfg_design, 
         statistic = "Chisq")
```
...
```{r}
svychisq(formula = ~myorient+id_BW,
         design = nsfg_design, 
         statistic = "Chisq")

svychisq(formula = ~myorient+id_LW,
         design = nsfg_design, 
         statistic = "Chisq")
```
...
```{r}
svychisq(formula = ~tbl1_usBorn+id_BW,
         design = nsfg_design, 
         statistic = "Chisq")

svychisq(formula = ~tbl1_usBorn+id_LW,
         design = nsfg_design, 
         statistic = "Chisq")
```
...
```{r}
svychisq(formula = ~tbl1_residence+id_BW,
         design = nsfg_design, 
         statistic = "Chisq")

svychisq(formula = ~tbl1_residence+id_LW,
         design = nsfg_design, 
         statistic = "Chisq")
```
...
```{r}
svychisq(formula = ~tbl1_relationship+id_BW,
         design = nsfg_design, 
         statistic = "Chisq")

svychisq(formula = ~tbl1_relationship+id_LW,
         design = nsfg_design, 
         statistic = "Chisq")
```
...
```{r}
svychisq(formula = ~tbl1_education+id_BW,
         design = nsfg_design, 
         statistic = "Chisq")

svychisq(formula = ~tbl1_education+id_LW,
         design = nsfg_design, 
         statistic = "Chisq")
```
...
```{r}
svychisq(formula = ~tbl1_householdFPL+id_BW,
         design = nsfg_design, 
         statistic = "Chisq")

svychisq(formula = ~tbl1_householdFPL+id_LW,
         design = nsfg_design, 
         statistic = "Chisq")
```
...
```{r}
svychisq(formula = ~tbl1_employment+id_BW,
         design = nsfg_design, 
         statistic = "Chisq")

svychisq(formula = ~tbl1_employment+id_LW,
         design = nsfg_design, 
         statistic = "Chisq")
```
...
```{r}
svychisq(formula = ~tbl1_healthInsurance+id_BW,
         design = nsfg_design, 
         statistic = "Chisq")

svychisq(formula = ~tbl1_healthInsurance+id_LW,
         design = nsfg_design, 
         statistic = "Chisq")
```
...
## to run all six, change outcome within svyglm
...
```{r}
logit1 <- (svyglm(liveBirth~mystrata_factor +
...
```{r}
logit2 <- (svyglm(inducedAbort~myNewGroups +
                    relevel(as.factor(tbl1_age), ref = 1) +
